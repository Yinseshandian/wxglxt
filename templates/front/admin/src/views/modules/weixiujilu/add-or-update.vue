		...
		>
			<template >
				...
				<el-form-item class="select" v-if="type!='info'"  label="维修结果" prop="weixiujieguo" >
					<el-select :disabled="ro.weixiujieguo" v-model="ruleForm.weixiujieguo" placeholder="请选择维修结果" >
						<el-option
				...
				<el-form-item v-else class="input" label="维修结果" prop="weixiujieguo" >
		...
		methods: {
			...
			init(id,type) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					this.ruleForm.weixiujieguo = '待确认'; 				}
				// 获取用户信息
				this.$http({
