		...
		>
			<template >
				...
				<el-form-item class="select" v-if="type!='info'"  label="报修状态" prop="baoxiuzhuangtai" >
					<el-select :disabled="ro.baoxiuzhuangtai" v-model="ruleForm.baoxiuzhuangtai" placeholder="请选择报修状态" >
						<el-option
				...
				<el-form-item v-else class="input" label="报修状态" prop="baoxiuzhuangtai" >
		...
		methods: {
			...
			init(id,type) {
				...
				if(this.type=='info'||this.type=='else'||this.type=='msg'){
					...
					this.ruleForm.baoxiuzhuangtai = '待分配'; 				}
				// 获取用户信息
				this.$http({
				...
				this.baoxiuzhuangtaiOptions = "已分配,待分配".split(',')
				this.jinjichengduOptions = "紧急,一般".split(',')
