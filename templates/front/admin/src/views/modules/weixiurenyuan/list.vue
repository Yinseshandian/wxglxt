		...
		<template v-if="showFlag">
			<el-form class="center-form-pv" :style='{"width":"100%","margin":"0 10px 20px"}' :inline="true" :model="searchForm">
				<el-row :style='{"width":"100%","padding":"10px","alignItems":"center","flexWrap":"wrap","background":"none","display":"flex"}' >
					...
					<div :style='{"alignItems":"center","margin":"0 10px 0 0","display":"flex"}'>
						<label :style='{"margin":"0 5px 0 0","whiteSpace":"nowrap","color":"#fff","display":"inline-block","width":"auto","lineHeight":"40px","fontSize":"15px","fontWeight":"500","height":"40px"}' class="item-label">维修姓名</label>
						<el-input v-model="searchForm.weixiuxingming" placeholder="维修姓名" @keydown.enter.native="search()" clearable></el-input>
					</div>
					<div :style='{"alignItems":"center","margin":"0 10px 0 0","display":"flex"}' class="select" label="维修身份" prop="weixiushenfen">
						<label :style='{"margin":"0 5px 0 0","whiteSpace":"nowrap","color":"#fff","display":"inline-block","width":"auto","lineHeight":"40px","fontSize":"15px","fontWeight":"500","height":"40px"}' class="item-label">维修身份</label>
						<el-select clearable v-model="searchForm.weixiushenfen" placeholder="请选择维修身份" >
							<el-option v-for="(item,index) in weixiushenfenOptions" v-bind:key="index" :label="item" :value="item"></el-option>
						</el-select>
					</div>
	...
	export default {
		...
		methods: {
			...
			getDataList() {
				...
				if(this.searchForm.weixiushenfen!='' && this.searchForm.weixiushenfen!=undefined){
					params['weixiushenfen'] = this.searchForm.weixiushenfen
				}
