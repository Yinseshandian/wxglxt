	...
	<div style="height: 100%;">
		<el-main :style='"vertical" == "vertical" ? (2 == 1 ? {"minHeight":"100%","padding":"0","margin":"0 0 0 210px","position":"relative","display":"block"} : (2 == 2 ? (isCollapse ? {"minHeight":"100%","padding":"0px 0 0 177px","margin":"0","position":"relative","background":"linear-gradient( 180deg, #4FC8FF 0%, rgba(255,255,255,0) 100%)","display":"block"} : {"minHeight":"100%","padding":"0px 0 0 177px","margin":"0","position":"relative","background":"linear-gradient( 180deg, #4FC8FF 0%, rgba(255,255,255,0) 100%)","display":"block"}) : "")) : {"minHeight":"100%","margin":"0","position":"relative"}'>
			...
			<template v-if="'vertical' == 'vertical'">
			  ...
			  <template v-if="2 == 2">
				<index-aside :is-collapse="isCollapse" @oncollapsechange="collapseChange" :style='isCollapse ? {"boxShadow":"0px 0 0px  rgba(0, 0, 0, .3)","padding":"20px 0 40px","bottom":"0","transition":"width 0.3s","overflow":"hidden","top":"15px","borderRadius":"10px","left":"15px","background":"#1B2026","width":"177px","fontSize":"15px","position":"fixed","height":"calc(100% - 30px)","zIndex":"1001"} : {"boxShadow":"0px 0 0px  rgba(0, 0, 0, .3)","padding":"40px 0","bottom":"0","transition":"width 0.3s","overflow":"hidden","top":"15px","borderRadius":"10px","left":"15px","background":"#1B2026","width":"177px","fontSize":"15px","position":"fixed","height":"calc(100% - 30px)","zIndex":"1001"}'></index-aside>
			  </template>
			</template>
			...
			<!-- breadcrumb -->
			<bread-crumbs :title="title" :style='{"padding":"15px 40px","margin":"30px auto 0 40px","borderColor":"#3b6885","borderRadius":"10px","borderWidth":"0 0 0px 0","background":"rgba(14, 39, 50, 0.50)","width":"calc(100% - 80px)","fontSize":"16px","borderStyle":"solid"}' class="bread-crumbs"></bread-crumbs>
